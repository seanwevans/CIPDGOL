...
def parse_args(args):
    ...
    argp.add_argument("--seed", default=None)
    argp.add_argument("--grid-size", default=512)
    argp.add_argument("--max-time-steps", default=99999999)
    argp.add_argument("--dt", default=0.1)
    argp.add_argument("--dx", default=1.0)
    argp.add_argument("--c", default=1.0)
    argp.add_argument("--max-cycle-length", default=1000)
    argp.add_argument("--no-clip", action="store_true")
    argp.add_argument("--prob-dist", default=[0.9, 0.1])
    argp.add_argument("--fps", default=60)
